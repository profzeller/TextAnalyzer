    ...
    try:
        response_3_5 = openai.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "Analyze the following text for its readability and provide scores for standard readability tests like the SMOG Index, Flesch-Kincaid Grade Level, Coleman-Liau Index, and Gunning Fog Index. The output should be in the following json format:\n\n    {{\n    'smog_index' = 3.5,\n    'flesch_kincaid_grade' = 2.5,\n    'coleman_liau_index' = 3.5,\n    'gunning_fog' = 2.5\n    }}\n\n"
                },
                {
                    "role": "user",
                    "content": text,
        ...
        for test, score in json.loads(response_3_5.choices[0].message['content']).items():
            ...
            submission.readability_scores[test].append({
                ...
                'usage': json.loads(response_3_5.usage),
            })
